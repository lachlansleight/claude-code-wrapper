...
function flattenParamUiFields(sections: readonly ParamUiSection[]): ParamField[] {
...
export const PARAM_FIELDS_UI_ORDER: readonly ParamField[] = flattenParamUiFields(PARAM_UI_SECTIONS);
...
export function mergeValuesIntoIndexedRow(row: ParamI16[], partial: Partial<FaceParams>): void {
...
export function mergeStrengthsIntoIndexedRow(row: ParamI16[], partial: Partial<FaceParams>): void {
    for (const k of Object.keys(partial) as ParamField[]) {
        const s = partial[k];
