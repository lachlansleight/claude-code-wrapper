...
// are zeroed — face geometry comes from kVerbTimelines + EffectsRenderer.
#ifndef FACE_P
...
static constexpr SparseVerbTimeline kVerbTimelines[] = {
    {Face::Expression::VerbThinking,
     28,
     {
         ...
         OI(Face::FieldIndex::EyeTopApex, -30),
         OI(Face::FieldIndex::EyeTopCorner, 0),
         OI(Face::FieldIndex::EyeBotApex, 30),
         OI(Face::FieldIndex::EyeBotCorner, 0),
         ...
         OI(Face::FieldIndex::PupilDx, 7),
         OI(Face::FieldIndex::PupilDy, -9),
         OI(Face::FieldIndex::PupilR, 15),
         OI(Face::FieldIndex::MouthDy, 0),
         OI(Face::FieldIndex::MouthRx, 11),
         OI(Face::FieldIndex::MouthTopApex, 3),
         OI(Face::FieldIndex::MouthTopCorner, 0),
         OI(Face::FieldIndex::MouthBotApex, 3),
         OI(Face::FieldIndex::MouthBotCorner, 0),
    ...
    {Face::Expression::VerbReading,
     28,
     {
         ...
         OI(Face::FieldIndex::EyeTopApex, -26),
         OI(Face::FieldIndex::EyeTopCorner, 0),
         OI(Face::FieldIndex::EyeBotApex, 26),
         OI(Face::FieldIndex::EyeBotCorner, 0),
         OI(Face::FieldIndex::EyeThick, 3),
         OI(Face::FieldIndex::EyeWaveAmp, 0),
         OI(Face::FieldIndex::EyeWaveFreq, 0),
         ...
         OI(Face::FieldIndex::PupilR, 12),
         OI(Face::FieldIndex::MouthDy, 0),
         OI(Face::FieldIndex::MouthRx, 9),
         OI(Face::FieldIndex::MouthTopApex, 3),
         OI(Face::FieldIndex::MouthTopCorner, 0),
         OI(Face::FieldIndex::MouthBotApex, 3),
         OI(Face::FieldIndex::MouthBotCorner, 0),
    ...
    {Face::Expression::VerbWriting,
     28,
     {
         ...
         OI(Face::FieldIndex::MouthTopApex, 0),
         OI(Face::FieldIndex::MouthTopCorner, 0),
         OI(Face::FieldIndex::MouthBotApex, 14),
         OI(Face::FieldIndex::MouthBotCorner, 0),
         OI(Face::FieldIndex::MouthThick, 3),
         OI(Face::FieldIndex::MouthWaveAmp, 0),
         OI(Face::FieldIndex::MouthWaveFreq, 0),
    ...
    {Face::Expression::VerbExecuting,
     28,
     {
         OI(Face::FieldIndex::EyeDy, 0),
         OI(Face::FieldIndex::EyeRx, 30),
         OI(Face::FieldIndex::EyeTopApex, -16),
         OI(Face::FieldIndex::EyeTopCorner, 0),
         OI(Face::FieldIndex::EyeBotApex, 16),
         OI(Face::FieldIndex::EyeBotCorner, 0),
         OI(Face::FieldIndex::EyeThick, 3),
         OI(Face::FieldIndex::EyeWaveAmp, 0),
         OI(Face::FieldIndex::EyeWaveFreq, 0),
         OI(Face::FieldIndex::EyeWaveSpeed, 0),
         OI(Face::FieldIndex::PupilDx, 0),
         OI(Face::FieldIndex::PupilDy, -4),
         OI(Face::FieldIndex::PupilR, 10),
         OI(Face::FieldIndex::MouthDy, 0),
         OI(Face::FieldIndex::MouthRx, 9),
         OI(Face::FieldIndex::MouthTopApex, 2),
         OI(Face::FieldIndex::MouthTopCorner, 0),
         OI(Face::FieldIndex::MouthBotApex, 2),
         OI(Face::FieldIndex::MouthBotCorner, 0),
         OI(Face::FieldIndex::MouthThick, 3),
         OI(Face::FieldIndex::MouthWaveAmp, 0),
         OI(Face::FieldIndex::MouthWaveFreq, 0),
    ...
    {Face::Expression::VerbStraining,
     28,
     {
         OI(Face::FieldIndex::EyeDy, 0),
         OI(Face::FieldIndex::EyeRx, 30),
         OI(Face::FieldIndex::EyeTopApex, -22),
         OI(Face::FieldIndex::EyeTopCorner, 0),
         OI(Face::FieldIndex::EyeBotApex, 22),
         OI(Face::FieldIndex::EyeBotCorner, 0),
         OI(Face::FieldIndex::EyeThick, 3),
         OI(Face::FieldIndex::EyeWaveAmp, 0),
         OI(Face::FieldIndex::EyeWaveFreq, 0),
         ...
         OI(Face::FieldIndex::MouthTopApex, 0),
         OI(Face::FieldIndex::MouthTopCorner, 0),
         OI(Face::FieldIndex::MouthBotApex, 0),
         OI(Face::FieldIndex::MouthBotCorner, 0),
         OI(Face::FieldIndex::MouthThick, 3),
         OI(Face::FieldIndex::MouthWaveAmp, 4),
         OI(Face::FieldIndex::MouthWaveFreq, 100),
         OI(Face::FieldIndex::MouthWaveSpeed, 360),
         OI(Face::FieldIndex::FaceRot, 0),
         OI(Face::FieldIndex::FaceY, 0),
    ...
    {Face::Expression::VerbSleeping,
     28,
     {
         OI(Face::FieldIndex::EyeDy, 8),
         OI(Face::FieldIndex::EyeRx, 26),
         OI(Face::FieldIndex::EyeTopApex, -2),
         OI(Face::FieldIndex::EyeTopCorner, 0),
         OI(Face::FieldIndex::EyeBotApex, 2),
         OI(Face::FieldIndex::EyeBotCorner, 0),
         OI(Face::FieldIndex::EyeThick, 3),
         OI(Face::FieldIndex::EyeWaveAmp, 0),
         OI(Face::FieldIndex::EyeWaveFreq, 0),
