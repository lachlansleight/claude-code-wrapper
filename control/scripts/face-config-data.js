...
(function () {
  ...
  // Emotion rows only — strength implicit 100. Verb rows in firmware are
  // FaceParams{} (zeroed); their geometry comes from verbTimelines below.
  // Overlay rows in firmware are also zeroed; the simulator uses
  // overlayPresets to approximate the look since it has no EffectsRenderer.
  const baseTargets = {
    Neutral:      [  2, 30,  -26, 0,  26, 0, 3,  0, 0, 0,    0,  3, 15,
                     0, 15,    2, 0,   2, 0, 3,  0, 0, 0,
                     0,  0,    0, 0, 0 ],
    Happy:        [  0, 30,  -16, 0,  30, 0, 3,  0, 0, 0,    0,  5, 16,
                     0, 24,    3, 0,   3, 0, 3,  0, 3, 0,
                     0,  5,    0, 0, 0 ],
  ...
  const verbTimelines = {
    VerbThinking: [
      ...
      ov("eye_top_apex", -30), ov("eye_top_corner", 0),
      ov("eye_bot_apex", 30), ov("eye_bot_corner", 0),
      ov("eye_thick", 3),
      ov("eye_wave_amp", 0), ov("eye_wave_freq", 0), ov("eye_wave_speed", 0),
      ov("pupil_dx", 7), ov("pupil_dy", -9), ov("pupil_r", 15),
      ov("mouth_dy", 0), ov("mouth_rx", 11),
      ov("mouth_top_apex", 3), ov("mouth_top_corner", 0),
      ov("mouth_bot_apex", 3), ov("mouth_bot_corner", 0),
      ov("mouth_thick", 3),
      ov("mouth_wave_amp", 0), ov("mouth_wave_freq", 0), ov("mouth_wave_speed", 0),
      ov("face_rot", -10), ov("face_y", 0),
      ov("ring_r", 36), ov("ring_g", 56), ov("ring_b", 120),
    ],
    VerbReading: [
      ov("eye_dy", 0), ov("eye_rx", 28),
      ov("eye_top_apex", -26), ov("eye_top_corner", 0),
      ov("eye_bot_apex", 26), ov("eye_bot_corner", 0),
      ov("eye_thick", 3),
      ov("eye_wave_amp", 0), ov("eye_wave_freq", 0), ov("eye_wave_speed", 0),
      ov("pupil_dx", 0), ov("pupil_dy", 8), ov("pupil_r", 12),
      ov("mouth_dy", 0), ov("mouth_rx", 9),
      ov("mouth_top_apex", 3), ov("mouth_top_corner", 0),
      ov("mouth_bot_apex", 3), ov("mouth_bot_corner", 0),
      ov("mouth_thick", 3),
      ov("mouth_wave_amp", 0), ov("mouth_wave_freq", 0), ov("mouth_wave_speed", 0),
      ov("face_rot", 0), ov("face_y", 12),
    ...
    VerbWriting: [
      ...
      ov("eye_thick", 3),
      ov("eye_wave_amp", 0), ov("eye_wave_freq", 0), ov("eye_wave_speed", 0),
      ov("pupil_dx", 0), ov("pupil_dy", -8), ov("pupil_r", 15),
      ov("mouth_dy", 0), ov("mouth_rx", 15),
      ov("mouth_top_apex", 0), ov("mouth_top_corner", 0),
      ov("mouth_bot_apex", 14), ov("mouth_bot_corner", 0),
      ov("mouth_thick", 3),
      ov("mouth_wave_amp", 0), ov("mouth_wave_freq", 0), ov("mouth_wave_speed", 0),
    ...
    VerbExecuting: [
      ov("eye_dy", 0), ov("eye_rx", 30),
      ov("eye_top_apex", -16), ov("eye_top_corner", 0),
      ov("eye_bot_apex", 16), ov("eye_bot_corner", 0),
      ov("eye_thick", 3),
      ov("eye_wave_amp", 0), ov("eye_wave_freq", 0), ov("eye_wave_speed", 0),
      ov("pupil_dx", 0), ov("pupil_dy", -4), ov("pupil_r", 10),
      ov("mouth_dy", 0), ov("mouth_rx", 9),
      ov("mouth_top_apex", 2), ov("mouth_top_corner", 0),
      ov("mouth_bot_apex", 2), ov("mouth_bot_corner", 0),
      ov("mouth_thick", 3),
      ov("mouth_wave_amp", 0), ov("mouth_wave_freq", 0), ov("mouth_wave_speed", 0),
      ov("face_rot", 0), ov("face_y", 0),
    ...
    VerbStraining: [
      ov("eye_dy", 0), ov("eye_rx", 30),
      ov("eye_top_apex", -22), ov("eye_top_corner", 0),
      ov("eye_bot_apex", 22), ov("eye_bot_corner", 0),
      ov("eye_thick", 3),
      ov("eye_wave_amp", 0), ov("eye_wave_freq", 0), ov("eye_wave_speed", 0),
      ov("pupil_dx", 0), ov("pupil_dy", -3), ov("pupil_r", 10),
      ov("mouth_dy", 0), ov("mouth_rx", 18),
      ov("mouth_top_apex", 0), ov("mouth_top_corner", 0),
      ov("mouth_bot_apex", 0), ov("mouth_bot_corner", 0),
      ov("mouth_thick", 3),
      ov("mouth_wave_amp", 4), ov("mouth_wave_freq", 100), ov("mouth_wave_speed", 360),
      ov("face_rot", 0), ov("face_y", 0),
      ov("ring_r", 210), ov("ring_g", 75), ov("ring_b", 220),
    ],
    VerbSleeping: [
      ov("eye_dy", 8), ov("eye_rx", 26),
      ov("eye_top_apex", -2), ov("eye_top_corner", 0),
      ov("eye_bot_apex", 2), ov("eye_bot_corner", 0),
      ov("eye_thick", 3),
      ov("eye_wave_amp", 0), ov("eye_wave_freq", 0), ov("eye_wave_speed", 0),
      ov("pupil_dx", 0), ov("pupil_dy", 0), ov("pupil_r", 15),
      ov("mouth_dy", 0), ov("mouth_rx", 9),
      ov("mouth_top_apex", 0), ov("mouth_top_corner", 0),
      ov("mouth_bot_apex", 0), ov("mouth_bot_corner", 0),
      ov("mouth_thick", 3),
