...
static void drawParabola(TFT_eSprite& s, int16_t cx, int16_t cy, int16_t w,
                         int16_t bend, int16_t thick, float cosA, float sinA) {
  if (w < 2) return;
  if (thick < 1) thick = 1;
...
static void drawEye(TFT_eSprite& s, const FaceParams& p, int16_t cx, int16_t cy,
                    float blinkAmt, int16_t gdx, int16_t gdy, float cosA,
                    float sinA) {
  int16_t ry = p.eye_ry;
  if (blinkAmt > 0.01f) {
...
static void drawHalfEllipse(TFT_eSprite& s, int16_t cx, int16_t cy, int16_t rx,
                            int16_t ry, float cosA, float sinA) {
  if (rx < 1 || ry < 1) return;
...
static void drawMouth(TFT_eSprite& s, const FaceParams& p, int16_t cx, int16_t cy,
                      Personality::State st, float cosA, float sinA) {
