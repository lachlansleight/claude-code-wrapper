...
from robot_v3/src/face/FACE_CONFIG.h. Each row is `{ v, a }, // Name`
...
FACE_CONFIG_H = REPO_ROOT / "robot_v3" / "src" / "face" / "FACE_CONFIG.h"
...
// in robot_v3/src/face/FACE_CONFIG.h. Re-run that script whenever that table
// changes.
//
// Anchors: {n_anchors}
...
def main() -> int:
    parsed = parse_emotion_points_from_cpp(FACE_CONFIG_H)
